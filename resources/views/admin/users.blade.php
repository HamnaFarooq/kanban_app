<x-app-layout>
        ...
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar pt-5">
                <ul>
                    ...
                    <li><a href="/admin_users" class="nav-link scrollto active"><i class="bx bx-user"></i> <span> Users </span></a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main id="main">
        ...
        <div class="row py-3" style="display: block;">
            <form action="/add_user" method="POST" autocomplete="off" class="d-flex">
                @csrf
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{ $user->email }} </td>
                    <td> {{ $user->type }} </td>
                    <td> <a href="/delete_user/{{$user->id}}"> <button class="btn btn-danger">Delete</button> </a> </td>
                </tr>
                @endforeach
            </tbody>
        </table>
